...
;NAME DEFINITIONS FOR GLOBAL VARIABLES ALLOCATED TO REGISTERS
	.DEF _pointer_recv=R4
	.DEF _pointer_recv_msb=R5
	.DEF __lcd_x=R7
	.DEF __lcd_y=R6
	.DEF __lcd_maxx=R9
...
__REG_VARS:
	.DB  LOW(_Receive),HIGH(_Receive)

_0x0:
	.DB  0x41,0x4D,0x32,0x33,0x31,0x35,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 009A         lcd_putchar(finish+'0');
	LDS  R26,_finish_S0000003000
	SUBI R26,-LOW(48)
	RCALL _lcd_putchar
; 0000 009B         finish++;
	LDS  R30,_finish_S0000003000
	SUBI R30,-LOW(1)
	STS  _finish_S0000003000,R30
